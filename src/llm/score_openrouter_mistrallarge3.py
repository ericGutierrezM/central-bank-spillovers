...
via OpenRouter (Mistral Large 3), using a 5-class scheme:
...
Run from the repo root: uv run python src/llm/score_openrouter_mistrallarge3.py
"""
...
MODEL_SLUG = 'mistralai/mistral-large-2512'        # EDIT if OpenRouter naming differs
MODEL_TAG  = 'MISTRALLARGE3'
# ----------------------------------------------------------------
